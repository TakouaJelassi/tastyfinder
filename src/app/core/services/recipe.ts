...
export class RecipeService {
  ...
  searchSmart(queryText: string): Observable<RecipePreview[]> {
    const stop = new Set([
      'ich', 'habe', 'hab', 'und', 'oder', 'was', 'kann', 'man', 'kochen',
      'machen', 'mit', 'heute', 'möchte', 'will', 'ein', 'eine', 'einen',
      'der', 'die', 'das', 'für', 'mir', 'zeig', 'zeige', 'etwas', 'gibt',
      'es', 'aus', 'noch', 'nur', 'auch', 'rezept', 'rezepte',
    ]);
